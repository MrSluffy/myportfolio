...
This is my personal portfolio where I put everything I learned in [Spring](https://spring.io/) and
[Vaadin](https://vaadin.com/docs) framework as frontend.
...
`java -jar target/myportfolio-1.0-SNAPSHOT.jar`
...
- `data` package in `src/main/java` contains the server-side backend of the application (i.e., the
